...
def CIEDE2000(Lab_1, Lab_2):
    ...
    T = (
        1
        - 0.17 * math.cos(h_ave - math.pi / 6)
        + 0.24 * math.cos(2 * h_ave)
        + 0.32 * math.cos(3 * h_ave + math.pi / 30)
        - 0.2 * math.cos(4 * h_ave - 63 * math.pi / 180)
    )
...
def CIELABdistance(p1, p2):
    ...
    return (weightR * r * r + weightG * g * g + weightB * b * b) ** (1 / 2)
...
# print(EuclideanDistance(pixel1, pixel2))
# print(EuclideanDistance(pixel1, pixel3))

# pixel1 = rgb2lab(pixel1)
# pixel2 = rgb2lab(pixel2)
# pixel3 = rgb2lab(pixel2)


# print(CIEDE2000(pixel1, pixel2))
# print(CIEDE2000(pixel1, pixel3))
